...
if __name__ == "__main__": 
    ...
    display = StringVar()
    entry = CTkEntry(master=root, textvariable=display, fg_color="#220A2E", border_color="#F3F3FF", width=500, height=100)
    ...
    calc_history_box = CTkTextbox(master=root, 
                         fg_color="#153755", #bg_color="#770c41",
                         scrollbar_button_color="#52017b",
                         width=300, height=100, corner_radius=16)
    ...
    zero_button = CTkButton(master=root, text="0", 
                            fg_color = "#02203c", bg_color="#02203c", text_color="#6b4082",
                            command=lambda: press(0),
                            height=75, width=75, font=("Arial",28))
